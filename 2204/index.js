console.log("Working...")
Boolean - (True /False), 
Strings - (Words, sentence, mix of numbers and words(ex - address)), 
...
data types present in JS(Primitive)
 ...
 Variables - They are used to store the values which could be of any type i.e. 
 Number type or String Type or Boolean type.
...
let fName = "Sidhant";
declared and initialized in the same linelet fname;
fname = "Lakhi";console.log(fname);
fname = "Lakhwinder";console.log(fname);
...
var age = 25;
 console.log(age);var age;age = 26;
